  ...
  <renderer-v2 referencescale="-1" enableorderby="0" symbollevels="0" type="singleSymbol" forceraster="0">
    <symbols>
      <symbol name="0" force_rhr="0" is_animated="0" type="line" clip_to_extent="1" alpha="1" frame_rate="10">
        ...
        <layer enabled="1" locked="0" id="{b60bb43b-6a05-4658-8100-10922ea24b8d}" class="MarkerLine" pass="0">
          <Option type="Map">
          ...
          <symbol name="@0@0" force_rhr="0" is_animated="0" type="marker" clip_to_extent="1" alpha="1" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" locked="0" id="{079bc5fd-a233-4ff6-bfd0-1a1757ace8ae}" class="SimpleMarker" pass="0">
              <Option type="Map">
                <Option name="angle" value="0" type="QString"/>
                <Option name="cap_style" value="square" type="QString"/>
                <Option name="color" value="69,158,66,219" type="QString"/>
        ...
        <layer enabled="1" locked="0" id="{b5ec457a-1923-4dea-a3d8-ab64a028b392}" class="SimpleLine" pass="0">
          <Option type="Map">
            ...
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="line_color" value="35,35,35,41" type="QString"/>
        ...
        <layer enabled="1" locked="0" id="{ac9d1180-65a0-43b0-a11b-20dccfeaf2ac}" class="GeometryGenerator" pass="0">
          <Option type="Map">
            <Option name="SymbolType" value="Line" type="QString"/>
            <Option name="geometryModifier" value="smooth($geometry, 3)&#xd;&#xa;" type="QString"/>
          ...
          <symbol name="@0@2" force_rhr="0" is_animated="0" type="line" clip_to_extent="1" alpha="1" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" locked="0" id="{acd7578f-c238-468c-abd6-e434d1ac2a45}" class="MarkerLine" pass="0">
              <Option type="Map">
                <Option name="average_angle_length" value="4" type="QString"/>
                <Option name="average_angle_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="average_angle_unit" value="MM" type="QString"/>
              ...
              <symbol name="@@0@2@0" force_rhr="0" is_animated="0" type="marker" clip_to_extent="1" alpha="1" frame_rate="10">
                <data_defined_properties>
                  <Option type="Map">
                    <Option name="name" value="" type="QString"/>
                    <Option name="properties"/>
                ...
                <layer enabled="1" locked="0" id="{74f77752-38fa-405e-8593-f813dac7979b}" class="SimpleMarker" pass="0">
                  <Option type="Map">
                    <Option name="angle" value="0" type="QString"/>
                    <Option name="cap_style" value="square" type="QString"/>
                    <Option name="color" value="63,88,117,255" type="QString"/>
                    <Option name="horizontal_anchor_point" value="1" type="QString"/>
                    <Option name="joinstyle" value="bevel" type="QString"/>
                    <Option name="name" value="circle" type="QString"/>
                    <Option name="offset" value="0,0" type="QString"/>
        ...
        <layer enabled="1" locked="0" id="{3177c867-765e-4829-bcf7-5f1cbef12a37}" class="GeometryGenerator" pass="0">
          ...
          <symbol name="@0@3" force_rhr="0" is_animated="0" type="line" clip_to_extent="1" alpha="1" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" locked="0" id="{7b0a9e78-b50b-46ae-879b-c18f70c0308d}" class="SimpleLine" pass="0">
              <Option type="Map">
                <Option name="align_dash_pattern" value="0" type="QString"/>
                <Option name="capstyle" value="square" type="QString"/>
                <Option name="customdash" value="5;2" type="QString"/>
                ...
                <Option name="draw_inside_polygon" value="0" type="QString"/>
                <Option name="joinstyle" value="bevel" type="QString"/>
                <Option name="line_color" value="55,139,233,255" type="QString"/>
                <Option name="line_style" value="solid" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" force_rhr="0" is_animated="0" type="line" clip_to_extent="1" alpha="1" frame_rate="10">
        ...
        <layer enabled="1" locked="0" id="{350ba75a-5508-4ea8-8970-22ebcbd0e51f}" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" value="0" type="QString"/>
            <Option name="capstyle" value="square" type="QString"/>
            <Option name="customdash" value="5;2" type="QString"/>
